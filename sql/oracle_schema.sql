...
create table brh.telefone_colaborador(
	...
	constraint tipo_telefone_valido check (tipo in ('M', 'R', 'C')) -- M: MOVEL, R: RESIDENCIAL, C: COMERCIAL
);
...
create table brh.dependente(
	...
	constraint fk_dependente_colaborador
		foreign key (colaborador)
		references brh.colaborador (matricula),
	constraint parentesco_valido check (parentesco in ('Conjuge', 'Filho(a)', 'Pai', 'Mae'))
);
...
--drop table brh.atribuicao cascade constraints;
--drop table brh.colaborador cascade constraints;
--drop table brh.departamento cascade constraints;
--drop table brh.dependente cascade constraints;
--drop table brh.email_colaborador cascade constraints;
--drop table brh.endereco cascade constraints;
--drop table brh.papel cascade constraints;
--drop table brh.projeto cascade constraints;
--drop table brh.telefone_colaborador cascade constraints;
